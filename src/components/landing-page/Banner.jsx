      ...
      <TrackVisibility>
            {({ isVisible }) => (
              <div
                className={
                  isVisible
                    ? " animate__animated animate__fadeIn banner"
                    : ""
                }
              >
                <Row className="mt-3">
                  <Col md={6} className="mt-md-5 pt-lg-5 ms- ms-md-0">
                    <div className="mt-5 mt-md-4 pt-4 pt-md-0">
                      ...
                      <p className="my-3 fs-normal fw-medium">
                        Unlock your full potential with our innovative
                        solutions.
                        <br className="d-none d-md-block" /> Think big,
                        transform your business, and build a brighter future.
                      </p>
                      <div className="btnn">
                        <Link
                          href="/contact"
